            ...
            <table align="center">
                <thead>
                    <tr>
                        ...
                        <% if( loginUser != null ) { %>
					        <td>
                            	<textarea cols="50" rows="3" id="reply-content" style="resize: none;"></textarea>
                        	</td>
                        	<td>
	                ...
	                window.onload = function(){	                	
	                	$.ajax({
	                		...
	                		success: function(res){
	                			console.log(res)
	                			const replyBody = document.querySelector(""#reply-area tblyd");
	                			...
	                			const replyBode = document.querySelector("#reply-area tbod");

    ...
    <div class="outer">
        ...
        <form action="" method="post" id="update-form">
            ...
            <div align="center">
                ...
                <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#member-delete-modal">회원탈퇴</button>
            </div>
        </form>
    </div>
	  ...
	  <div class="modal-dialog modal-dialog-centered">
	    <div class="modal-content">
	      ...
	      <div class="modal-body" align="center">
	        ...
	        <script>
	        	documetn.getElementById("edit-pwd-btn").onclick = function(){
		            const pwd = document.querySelector("input[name=updatePwd]").value
		            const pwdCheck = document.querySelector("input[name=updatePwdCheck]").value
	    ...
	    <div class="modal-content">
	      ...
	      <div class="modal-body" align="center">
	        <form action="<%=contextPath%>/delete.me" method="post">
	        	...
	        	<br><br>
	        	<button id="delete-btn" type="submit" class="btn btn-sm btn-danger">
	        		탈퇴하기
	        	</button>
	        </form>

...
<body>
	<h3>1. 산술 연산</h3>
	기본 : 10 + 3 = <%=(int)request.getAttribute("big") + (int)request.getAttribute("small") %>
	...
	sThree에 담긴값이 '안녕과 일치합니까? ${sThree == 'HI'}<br><br>
	<!-- el구문안에서 문자열 리터럴값은 홀따옴표 쌍따옴표를 가리지 않음 -->
	
	<h4>4. 객체가 null인지 아닌지 리스트가 비었는지 비교</h4>
	pTwo가 null입니까? ${pTwo == null} 또는 ${pTwo eq null} ${empty pTwo} <br>
	pOne가 null입니까? ${pOne == null} 또는 ${pOne eq null} ${empty pOne} <br>

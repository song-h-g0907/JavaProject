...
<body>
    <h1>* EL(Expreesion language)</h1>

    <p>
        기본에 사용했던 표현식(출력식) &lt;%=name%&gt;와 같이 <br>
	...
	<!-- 
		*JSP를 이루는 구성
		...
		3. 액션태그 : jsp페이지에서 어떤 동작을 하도록 지시하는 태그
		   ...
		   >>표준액션태그(Standard Action Tag) : jsp페이지에서 바로 사용가능(별도로 연동 필요 없음)
	 ...
	 <a href="views/3_Custom_Action_Tag/03_fn.jsp">02_fn</a>
</body>
</html>

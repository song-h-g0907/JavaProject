/*
    ...
    DCL(CONTROL 데이터 정어어) : GRANT, REVOKE
    TCL(TRANSACTION 트랜잭션 제어어) : COMMIT, ROLLBACK
    
    
    <DML>
    데이터 조작언어
    테이블 값을 삽입(INTSERT), 수정(UPDATE), 삭제(DELETE)하는 구문
...
INSERT INTO EMPLOYEE VALUES (900,'이소근','880914-145678','SG8809@NAVER.COM','01078945656', 'D7','J5',4000000,0.2,200,SYSDATE, NULL,'N');
...
VALUES(901,'최지원','440701-1234567','J3',SYSDATE);

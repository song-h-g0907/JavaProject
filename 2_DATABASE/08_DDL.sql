...
ALTER TABLE DEPT_TABLE ADD CANME VARCHAR2(20);
...
/*
    ...
    제약조건명 지정하고자 한다면 [CONSTRAINT 제양조건명] 제약조건
*/
...
ALTER TABLE DEPT_TABLE
        ...
        ADD CONSTRAINT DTABLE_UQ UNIQUE(DEPT_NAME)
...
--어딘가에 참조되고있는 부모테이블은 모두 함부로 삭제가 되지 않는다.
--만약 지우고자한다면
--1. 자식테이블 먼저 전부 삭제
...
ALTER TABLE DEPT_TABLE RENAME CONSTRAINT SYS_C007044 TO DTABLE_ID_NN;

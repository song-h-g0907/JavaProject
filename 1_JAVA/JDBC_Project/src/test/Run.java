...
public class Run {
	 ...
	 * - ResultSet : SELECT문 실행 후 조회된 결과물을 다는 객체
	 * 
	 * *JDBC 과정
	...
	public static void main(String[] args) {
		...
		//실행할 sql문(완전한 상태로 sql문을 구성해준다/ 맨뒤에 ; 생략)
		...
		*/
		//2. 내 PC에 있는 DB에서 JDBC계정에 연결해 TEST테이블의 모든데이터 조회해오기
		Connection conn = null;
		Statement stmt = null;
		ResultSet rset = null;
		//실행할 sql문

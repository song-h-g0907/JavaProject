...
public class Run {
	/*
	 * 상속이란
	 * 부모클래스의 필드와 메소드를 자식클래스에서 그대로 이어 받아 사용하는 것
	 ...
	 * 
	 * 상속의 특징
	 * -클래스간의 다중상속 불가(부모는 하나다)
	 * -부모클래스에 정의되어있는 protected필드는 자식클래스에서 직접 접근이 가능하다(private는 접근불가)
	...
	public static void main(String[] args) {
		...
		//boolean allinOne
		Product d1 = new Desktop("LG","100","사무용PC",1000000,true);
		...
		Product d2 = new TV("LG","101","TV",1500000,55);

...
public class Run {
	...
	public static void main(String[] args) {
		...
		Car c1 = new Car(2020,"빨강","가솔린");
		c1.drive();
		
		//2. 자식타입 레퍼런스로 자식객체를 다루는경우
		Avante c2 = new Avante(2022,"검은색","디젤");
		c2.drive();
		c2.moveAvante();
		...
		sonataArr[0] = new Sonata(2023,"흰색","가스");
		Avante[] avanteArr = new Avante[5];
		avanteArr[0] = new Avante(2022,"검은색","디젤");
		
		//다형성 사용 후
		Car[] carArr = new Car[4];
		carArr[0] = new Sonata(2021,"흰색","가스");
		carArr[1] = new Avante(2022,"검은색","디젤");
		carArr[2] = new Sonata(2023,"빨강색","가스");
		carArr[3] = new Avante(2024,"회색","디젤");

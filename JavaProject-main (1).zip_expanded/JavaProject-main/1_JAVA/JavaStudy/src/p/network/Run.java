...
public class Run {
	public static void main(String[] args) {
		try {
			...
			System.out.println("goole 서버명 : "+ googleHost.getHostName()); //google의 이름을 반환
			...
			for (InetAddress n : naverHost) {
				System.out.println("네이버 서버명 : "+ n.getHostName()); //google의 이름을 반환
				System.out.println("네이버 IP주소 : " + n.getHostAddress()); //google의 IP주소를 반환
			}

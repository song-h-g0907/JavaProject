...
public class SetRun {
	...
	public static void main(String[] args) {
		//object에 equals() => 두 객체의 "주소값"을 비교해ㅓ 일치하면 true/일치하지않으면 false
		//Object에 hashCode() => 해당객체의 "주소값"을 가지고 10진수의 형태로 만들어서 변환
		...
		hsi.add(new String("여러분"));
		System.out.println(hsi); //저장순서를 유지하지 않는다! 중복된 데이터(통일객체) 보관 불가
		//String에 equals() =>"실제 담긴 문자열"을 가지고 동등비교를 진행해서 일치하면 true/일치하지 않으면 false
